# BCN Fire simulation and land cover effects
...
batch_size     <- 20   # process 20 ignitions at a time
mc_time_step   <- 5
mc_time_horizon<- 180
...
# 6. Save
# ============================================================
saveRDS(perc_data_long, "./data/rdat/perc_data_long_WUI_TEST.rds")
